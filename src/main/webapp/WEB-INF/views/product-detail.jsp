							...
							<div class="container">
								...
								<div class="collapse navbar-collapse" id="header-bottom">
									<ul class="nav navbar-nav">
										...
										<li  class="active"><a href="product-detail.jsp" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Shop</a><span class="label label-danger text-center hidden-xs">New <i class="fa fa-caret-right"></i></span>
											<ul class="dropdown-menu">
				...
				<div class="row">
					<div class="col-sm-5">
						<div id="pro-img" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner" role="listbox">
								<div class="item active"><img src="images/desk-com.jpg" alt=""></div>
								<div class="item"><img src="images/desk-com.jpg" alt=""></div>
								<div class="item"><img src="images/desk-com.jpg" alt=""></div>
							</div>
					...
					<div class="col-sm-7">
						<div class="pro-details">
							...
							<h2>Nam apeirian assentior eros posse</h2>
							...
							<div class="currency">$2080.99 <span>$389.00</span></div>
						...
						<div class="description">
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="additional-info">
									<h2>Product's More Information</h2>
									<p>Lorem ipsum dolor sit amet, no mea aeterno indoctum percipitur. Homero quaerendum ius ei. In pro decore tamquam 									appetere, ea mentitum mediocrem efficiantur quo. Quo no assentior conclusionemque. Qui cu ceteros accusata. Partem 									utamur explicari eos at. Ad brute veritus theophrastus vis, an quo mutat voluptaria mnesarchum, eum impetus numquam 								intellegam in. Eu alii oratio aliquip mea, eum inani tantas ex. In sit vidit eirmod, ceteros reprimique sit cu, 								    facilisis assueverit disputationi ad est.</p>
		...
		<section class="featured-product">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<div class="">
							<h1><span class="t-color-1">Featured</span> Products</h1>
							<div class="heading-border b-color-1"></div>
						</div>
					</div>
				</div> <!-- section title -->
				<div id="related-pro" class="carousel slide" data-ride="carousel">
					<ol class="carousel-indicators">
						<li data-target="#related-pro" data-slide-to="0" class="active"><i class="fa fa-angle-left"></i></li>
						<li data-target="#related-pro" data-slide-to="1"><i class="fa fa-angle-right"></i></li>
					</ol>
					<div class="carousel-inner" role="listbox">
