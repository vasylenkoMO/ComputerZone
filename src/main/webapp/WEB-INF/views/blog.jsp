	...
	<body>
		...
		<section class="desktop-bar">
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
					 <h3>Blog <i class="fa fa-bars"></i></h3>
					</div>
					<div class="col-sm-8">
				...
				<div class="row">
					...
					<div class="col-sm-9 blog-detail-wrap">
						<div class="row post-bottom">
							<div class="col-sm-12">
								<div><img id="pro-img" class="img-responsive" src="images/about-us.jpg" alt=""></div>
								<div class="blog-content">
									<h2>Lorem ipsum dolor sit amet mea aeterno</h2>
									<ul class="list-inline post-info">
										<li>Septembar 12, 2016</li>
										<li><a href="#"><i class="fa fa-user"></i> Jhon Ray</a></li>
										<li><a href="#"><i class="fa fa-bookmark"></i> Category Name</a></li>
										<li><a href="#"><i class="fa fa-comment"></i> 5 Comments</a></li>
										<li><a href="#"><i class="fa fa-plus"></i> Read More</a></li>
									</ul>
						...
						<div class="row post-bottom">
							<div class="col-sm-12">
								<div class="embed-responsive embed-responsive-16by9">
								  	<iframe id="pro-img" class="embed-responsive-item" src="https://www.youtube.com/embed/tMVDWvHlrRc"></iframe>
								</div>
								<div class="blog-content">
									<h2>Lorem ipsum dolor sit amet mea aeterno</h2>
									<ul class="list-inline post-info">
