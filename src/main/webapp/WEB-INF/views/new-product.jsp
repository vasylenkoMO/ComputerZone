	...
	<body>
		...
		<section class="desktop-bar">
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
					 	<h3>New Products <i class="fa fa-bars"></i></h3>
					</div>
					<div class="col-sm-8">
										...
										<div class="media desk-media">
											...
											<div class="media-body">
												...
												<div class="list-inline">
													...
													<li><span class="wish"><i class="fa fa-heart-o"></i> Add to Wishlist</span></li>
													<li><span><i class="fa fa-file-pdf-o"></i> Compare</span></li>
												</div>
											</div>
										</div>
										<div class="media desk-media">
